...
[![Build Status](https://travis-ci.org/3pillarlabs/fluent-qat.svg?branch=develop)](https://travis-ci.org/3pillarlabs/fluent-qat) [![Code Quality](https://sonarcloud.io/api/project_badges/measure?project=3pillar-labs-github&metric=alert_status)](https://sonarcloud.io/dashboard?id=3pillar-labs-github)
